...
project = 'Tradução do Livro de Miller e Ranum'
copyright = '2019 DCC IME USP'
...
html_theme_options = {
    ...
    'navbar_title': "Resolução de Problemas Usando Python",

    # Tab name for entire site. (Default: "Site")
    'navbar_site_name': "Capitulos",
...
html_title = 'Resolução de Problemas Usando Python'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Resolução de Problemas'
